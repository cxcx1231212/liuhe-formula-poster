...
export async function GET(request:NextRequest){
  ...
  const svg=`<svg xmlns="http://www.w3.org/2000/svg" width="750" height="520" viewBox="0 0 750 520"><style>.head{font:700 18px Arial,'Microsoft YaHei',sans-serif;fill:#163f70}.period{font:700 18px Arial,'Microsoft YaHei',sans-serif;fill:#1d5eb5}.date{font:12px Arial,'Microsoft YaHei',sans-serif;fill:#536b86}.num{font:700 18px Arial,sans-serif;fill:#222}.animal{font:17px Arial,'Microsoft YaHei',sans-serif;fill:#536b86}.op{font:700 18px Arial,'Microsoft YaHei',sans-serif;fill:#fff}</style><defs><marker id="arrow" markerWidth="8" markerHeight="8" refX="7" refY="4" orient="auto"><path d="M0 0L8 4L0 8z" fill="#d71920"/></marker></defs><rect width="750" height="520" fill="#fff"/><rect width="750" height="43" fill="#edf5ff"/><g class="head" text-anchor="middle"><text x="39" y="29">期号</text><text x="108" y="29">平1码</text><text x="188" y="29">平2码</text><text x="268" y="29">平3码</text><text x="348" y="29">平4码</text><text x="428" y="29">平5码</text><text x="508" y="29">平6码</text><text x="608" y="29">特码</text></g><line x1="0" y1="43" x2="750" y2="43" stroke="#9fc4ef"/><rect x="0" y="44" width="750" height="82" fill="#f8fbff" stroke="#9fc4ef"/><text x="39" y="76" text-anchor="middle" class="period">${esc(String(item.issue).padStart(3,'0'))}期</text><text x="39" y="99" text-anchor="middle" class="date">下期预测</text><text x="370" y="91" text-anchor="middle" style="font:700 25px Arial,'Microsoft YaHei',sans-serif;fill:#d71920">${esc(next)}</text>${rows}<text x="375" y="302" text-anchor="middle" transform="rotate(-32 375 302)" style="font:700 52px Arial,sans-serif;fill:#1d5eb5;opacity:.08;letter-spacing:8px">GS88888.COM</text></svg>`;
