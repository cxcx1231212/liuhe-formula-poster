...
export default function IssueScroller({issues,current,basePath,method,type,methods}:{issues:number[];current:number;basePath:string;method:string;type:string;methods?:Record<number,string>}){
