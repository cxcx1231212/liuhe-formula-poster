...
export default function DynamicSimpleFormulaPost({type,issue,method,item,draws,board,hash,basePath,index,total,note,posterItemOverride,periodNav}:{type:LotteryType;issue:string;method:string;item:RawMethod;draws:any[];board:string;hash:string;basePath:string;index:number;total:number;note:string;posterItemOverride?:any;periodNav?:ReactNode}){
